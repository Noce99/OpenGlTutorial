...
glm::vec3 initialLightLoc = glm::vec3(5.0f, 2.0f, 2.0f);// Initial Light position
...
void init (GLFWwindow* window){
    ...
    cameraX = 0.0f; cameraY = 7.0f; cameraZ = 2.0f;
...
void display (GLFWwindow* window, double currentTime){
    ...
    cameraZ = (5+3*cos((float)currentTime))*sin((float)currentTime*0.6);
    cameraX = (5+3*cos((float)currentTime))*cos((float)currentTime*0.6);
