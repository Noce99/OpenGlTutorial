...
void display (GLFWwindow* window, double currentTime){
    ...
    //Associazione VBO
    glBindBuffer(GL_ARRAY_BUFFER, vbo[0]);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, 0); // Primo attributo deve essere uguale a location in layout definita negli shaders
    glEnableVertexAttribArray(0); // 0 come sopra è quello in location in layout negli shaders
